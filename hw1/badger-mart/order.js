...
function calculateSalesTax() {
	const selectedState = document.getElementById("state-tax").value
	return calculateSubtotal() * getSalesTaxRateForState(selectedState)
}
...
document.getElementById("btn-checkout").addEventListener("click", () => {
	alert("Your total is: $" + calculateTotal().toFixed(2))
})
